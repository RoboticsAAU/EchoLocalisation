...
estimates.emUca.tdoa=computeTdoasCenter(estimates.emUca.angle,setup);
...
for ee=1:setup.EM.nIter
    ...
    for kk=1:setup.EM.nRefl
        for aa=1:length(grids.angle)
            ...
            tdoaCand=computeTdoasCenter(angleCand,setup);
        ...
        estimates.emUca.tdoa(:,kk)=computeTdoasCenter(estimates.emUca.angle(kk),setup);
